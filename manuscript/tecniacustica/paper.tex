...
\textbf{Modelado diferenciable.} DDSP~\cite{engel2020ddsp} reformula procesado clásico como operaciones diferenciables. El estado del arte acopla renderizado diferenciable con componentes neuronales y de elementos finitos para invertir material, forma y excitación~\cite{jin2024diffsound,lee2024modal}. Nuestro marco comparte la inversión por gradiente pero es \emph{deliberadamente no entrenado}: los parámetros físicos se exponen directamente, sin red neuronal.
